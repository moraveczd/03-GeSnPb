	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Ve vesmíru se jedná o čtvrtý nejběžnější prvek, v lidském těle ho najdeme 18,5 \%.
	...
	\begin{columns}
		\begin{column}{0.65\textwidth}
			...
			\begin{itemize}
				...
				\item Využívají se ve šperkařství i v průmyslu. Chemicky je inertní.
				\item Některé diamanty mají polovodivé vlastnosti.
				\item Pro průmyslové aplikace se využívají diamanty nevhodné pro šperky nebo umělé diamanty.
			\end{itemize}
			\vfill
		\end{column}
...
\frame{
	...
	\begin{columns}
		\begin{column}{0.65\textwidth}
			\vfill
			\begin{itemize}
				\item HPHT -- High Pressure, High Temperature -- pomocí lisu je zahříván čistý uhlík na vysokou teplotu, za vysokého tlaku. V přítomnosti kovového katalyzátoru vzniká krystal diamantu.
...
\frame{
	...
	\begin{columns}
		\begin{column}{0.65\textwidth}
			\begin{itemize}
				\item Křemík je velmi zajímavý prvek jak z hlediska chemických vlastností, tak i z hlediska praktických aplikací.
		...
		\begin{column}{0.4\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.3\textheight]{img/Berzelius.jpg}
...
\frame{
	...
	\begin{itemize}
		...
		\item Využívá se jako zdroj křemíku pro redukci oxidů kovůa pro přípravu deoxygenované oceli.
		\item Slouží i jako zdroj křemíku pro průmyslovou přípravu \ce{SiHCl3}.
...
\frame{
	...
	\begin{figure}
		...
		\caption*{Vývoj počtu tranzistorů an čipech v letech 1970--2020.\footnote[frame]{Zdroj: \href{https://en.wikipedia.org/wiki/File:Moore\%27s_Law_Transistor_Count_1970-2020.png}{Max Roser, Hannah Ritchie/Commons}}}
	\end{figure}
	\vfill
}
...
\frame{
	...
	\textit{Flerovium}
		\begin{itemize}
			...
			\item \ce{^{244}_{94}Pu + ^{48}_{20}Ca -> ^{292}_{114}Fl$^\star$ -> ^{290}_{114}Fl + 2 n}
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Germanium je polokov s podobným měrným odporem jako křemík, ale s menší šířkou zakázaného pásu.
		\item Je elektropozitivnější a reaktivnější než křemík, rozpouští se v koncentrované kyselině sírové a dusičné.
		\item Cín reaguje ochotně s chlorem a bromem i za nižší teploty.
		\item Olovo v jemně práškovém stavu je pyroforické, ale v bulkovém stavu je poměrně málo reaktivní.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Germanium existuje ve dvou modifikacích, $\alpha$-Ge má kubickou krystalovou strukturu.
		...
		\item Cín existuje také ve dvou hlavních alotropních modifikacích.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Kasiterir lze snadno redukovat uhlíkem za vysoké teploty.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item Olovo je nejrozšířenějším těžkým kovem, jeho koncentrace v zemské kůře je okolo 16~ppm.
		...
		\item Nevyskytuje se v čisté stavu, ale je součástí mnoha minerálů. Nejdůležitější je \textit{galenit} (PbS), který slouží jako zdroj pro průmyslovou výrobu.
	\end{itemize}
	\begin{center}
		\begin{tabular}{|c|c|}
			\hline
			...
			cerussit &  \ce{PbCO3} \\
			\hline
			pyromorfit &  \ce{Pb5(PO4)3Cl} \\
			\hline
			cerussit &  \ce{Pb5(AsO4)3Cl} \\
			\hline
		\end{tabular}
	\end{center}
	\vfill
...
\frame{
	...
	\vfill
	\begin{figure}
		\adjincludegraphics[width=1\textwidth]{img/Radioactive_decay_chains_diagram.png}
...
\frame{
	...
	\textbf{Cerusit}
	\begin{itemize}
		\item Uhličitan olovnatý, \ce{PbCO3}.
	...
	\begin{columns}
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[width=0.8\textwidth]{img/Cerussite-18566.jpg}
		...
		\begin{column}{.4\textwidth}
			\begin{figure}
				\adjincludegraphics[width=0.8\textwidth]{img/Cerussite-Malachite-Mimetite-158529.jpg}
...
\frame{
	...
	\begin{itemize}
		\item Důležitým zdrojem olova (ale i jiných kovů) je i recyklace.\footnote[frame]{\href{https://www.youtube.com/watch?v=eO-X8Gw2nXY}{Lead Battery Recycling Process}}
...
\frame{
	\frametitle{}
	\begin{itemize}
		\item Oxidy cínu se využívají jako heterogenní katalyzátory, např. směsné oxidy Sn-V se používají pro oxidaci benzenu a toluenu.
	...
	\begin{columns}
		\begin{column}{.7\textwidth}
			\begin{itemize}
				...
				\item Vyrábějí se v kapacitách od 1 do 10 000 Ah.\footnote[frame]{\href{https://www.pveducation.org/pvcdrom/battery-characteristics/battery-capacity}{Battery Capacity}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Vybitá baterie má obě elektrody ze síranu olovnatého.
		\item Vybíjení:
...
\frame{
	\frametitle{}
	\begin{itemize}
		\item Olovo je součástí několika pigmentů, vzhledem k toxicitě olova se ale už nepoužívají.
		\item Chromová žluť, \ce{PbCrO4}, v přírodě se nachází jako minerál \textit{krokoit}. Má silné oxidační účinky.\footnote[frame]{\href{https://pubchem.ncbi.nlm.nih.gov/compound/24460}{Lead chromate -- PubChem}}
...
\frame{
	...
	\begin{itemize}
		...
		\item Při reakci s alkalickými kovy v kapalném amoniaku vznikají příslušné soli.
...
\frame{
	...
	\begin{itemize}
		...
		\item Vzniká reakcí chloridu cíničitého tetrahydridoboritanem lithným.
		\item \ce{SnCl4 + LiAlH4 ->[Et2O] SnH4 + LiCl + AlCl3}
		\item \textbf{Distannan}, \ce{Sn2H6}, je ještě méně stálý než stannan.
...
\frame{
	...
	\begin{itemize}
		...
		\item Rozpouštěním v alkalických hydroxidech vznikají tetraedrické germaničitany, \ce{GeO4^{4-}}.
	\end{itemize}
	\vfill
}
	...
	\begin{columns}
		\begin{column}{.65\textwidth}
			\begin{itemize}
				...
				\item Syntetický oxid cíničitý se připravuje spalováním cínu na vzduchu.
...
\frame{
	...
	\begin{itemize}
		...
		\item Má podobnou strukturu jako izoelektronový černý fosfor, vrstvy složené z šestičlenných cyklů.
...
\frame{
	...
	\vfill
	\begin{itemize}
		\item U halogenidů cínatých (\ce{SnX2})se pozorujeme stereochemickou pasivitu nevazebného elektronového páru. Tyto sloučeniny mají také sklon zvyšovat si koordinační číslo a tím tvořit větší cyklické nebo řetězovité molekuly.
		...
		\item \textbf{Fluorid cínatý}, \ce{SnF2}, získáme odpaření roztoku \ce{SnO} v \ce{HF}.
	...
	\vfill
		...
		\begin{column}{0.6\textwidth}
			\begin{itemize}
				...
				\item Bromid i jodid můžeme připravit srážením olovnatých solí, u jodidu jde o oblíbený pokus - \textit{Zlatý déšť}.\footnote[frame]{\href{https://cs.wikibooks.org/wiki/Chemické_pokusy/Zlatý_déšť}{Zlatý déšť}}
